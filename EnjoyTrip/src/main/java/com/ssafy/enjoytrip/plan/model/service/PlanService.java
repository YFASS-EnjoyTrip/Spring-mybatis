...
public interface PlanService {
    ...
    List<Map<String, DayForm>> findPlanDetail(Map<String, String> param) throws Exception;
    ...
    List<Map<String, Object>> createPlan(Map<String, Object> param) throws Exception;
}
